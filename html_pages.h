...
const char html_page_irrigation[] PROGMEM =
"<div id='l1' name='l1'>"
    "<fieldset>"
        "<legend><b>&nbsp; _TXT_IRRIGATION_TITLE_ &nbsp;</b></legend>"
        "<form method='post'>"
            "<p><b>_TXT_IRRIGATION_VALVE1_</b>"
                "<select name='v1'>"
                    "<option value='V1P0' _V1P0_>_TXT_P0_</option>"
                    "<option value='V1P1' _V1P1_>_TXT_P1_</option>"
                    "<option value='V1P2' _V1P2_>_TXT_P2_</option>"
                    "<option value='V1P3' _V1P3_>_TXT_P3_</option>"
                    "<option value='V1P4' _V1P4_>_TXT_P4_</option>"
                    "<option value='V1P5' _V1P5_>_TXT_P5_</option>"
                    "<option value='V1P6' _V1P6_>_TXT_P6_</option>"
                    "<option value='V1P7' _V1P7_>_TXT_P7_</option>"
                    "<option value='V1P8' _V1P8_>_TXT_P8_</option>"
                    "<option value='V1TX' _V1TX_>_TXT_TX_</option>"
                    "<option value='V1RX' _V1RX_>_TXT_RX_</option>"
                "</select>"
            "</p>"
            "<br/>"
            "<button name='save' type='submit' class='button bgrn'>_TXT_SAVE_</button>"
